...
<?php
    //La fonction de connexion a MySQL via PDO
    function connexion(){
        ...
        try {
            ...
            //Variable de connexion = Instance de la classe PDO + paramètre du constructeur(hote + nom de la base  +  nom utilisateur + )
        ...
        if(isset($_POST['email']) && !empty($_POST['email']) && isset($_POST['password']) && !empty($_POST['password'])){
            ...
            if($connexion->rowCount() >= 0){
                ...
                if($ligne){
                    //On recup les email et password de la table 
                    //$ligne['email'] = attribut de votre table 
